...
//    motor_9025_can_tx_data[0] = 0xA8;
//    motor_9025_can_tx_data[1] = 0x00;
//    motor_9025_can_tx_data[2] = *(uint8_t *)(&maxSpeed);
//    motor_9025_can_tx_data[3] = *(uint8_t *)(&maxSpeed+1);
//    motor_9025_can_tx_data[4] = *(uint8_t *)(& angleIncrement);
//    motor_9025_can_tx_data[5] = *(uint8_t *)(& angleIncrement+1);
//    motor_9025_can_tx_data[6] = *(uint8_t *)(& angleIncrement+2);
//    motor_9025_can_tx_data[7] = *(uint8_t *)(& angleIncrement+3);
//    HAL_CAN_AddTxMessage(&MOTOR_9025_CAN, &motor_9025_tx_message, motor_9025_can_tx_data, &send_mail_box);	
}
/*------------------------------------------------------------------------*/
/*
