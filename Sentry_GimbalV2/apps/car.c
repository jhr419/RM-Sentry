...
//6020
//GYRO
#define M6020_YAW_GYRO_PID_KP 				1.0f
#define M6020_YAW_GYRO_PID_KI 				0.0f
#define M6020_YAW_GYRO_PID_KD 				1.0f
#define M6020_YAW_GYRO_PID_MAX_OUT 		8000.0f
#define M6020_YAW_GYRO_PID_MAX_IOUT 	800.0f

#define M6020_PITCH_GYRO_PID_KP 				0.8f	
#define M6020_PITCH_GYRO_PID_KI 				0.0f	
#define M6020_PITCH_GYRO_PID_KD 				0.4f	
#define M6020_PITCH_GYRO_PID_MAX_OUT 		8000.0f	
#define M6020_PITCH_GYRO_PID_MAX_IOUT 	8000.0f

//ecd
#define M6020_YAW_ECD_PID_KP 				0.0f
#define M6020_YAW_ECD_PID_KI 				0.0f
#define M6020_YAW_ECD_PID_KD 				0.0f
#define M6020_YAW_ECD_PID_MAX_OUT 	8000.0f
#define M6020_YAW_ECD_PID_MAX_IOUT 	800.0f

#define M6020_PITCH_ECD_PID_KP 				0.0f
#define M6020_PITCH_ECD_PID_KI 				0.0f
#define M6020_PITCH_ECD_PID_KD 				0.0f
#define M6020_PITCH_ECD_PID_MAX_OUT 	0.0f
#define M6020_PITCH_ECD_PID_MAX_IOUT 	0.0f
...
fp32 M6020_yaw_ecd_pid_k[3] 	 = {M6020_YAW_GYRO_PID_KP, M6020_YAW_GYRO_PID_KI, M6020_YAW_GYRO_PID_KD};
fp32 M6020_pitch_ecd_pid_k[3] = {M6020_PITCH_GYRO_PID_KP, M6020_PITCH_GYRO_PID_KI, M6020_PITCH_GYRO_PID_KD};

fp32 M6020_yaw_gyro_pid_k[3] 	 = {M6020_YAW_GYRO_PID_KP, M6020_YAW_GYRO_PID_KI, M6020_YAW_GYRO_PID_KD};
fp32 M6020_pitch_gyro_pid_k[3] = {M6020_PITCH_GYRO_PID_KP, M6020_PITCH_GYRO_PID_KI, M6020_PITCH_GYRO_PID_KD};
...
void car_init(void)//TODO:如何制定car类型及其参数
{
	...
	gimbal_init(PID_POSITION,
				...
				M6020_yaw_gyro_pid_k, M6020_pitch_gyro_pid_k,
				M6020_yaw_ecd_pid_k, M6020_pitch_ecd_pid_k,
				M6020_yaw_rpm_pid_k, M6020_pitch_rpm_pid_k,

				M6020_YAW_GYRO_PID_MAX_OUT,
				M6020_YAW_GYRO_PID_MAX_IOUT,
				M6020_PITCH_GYRO_PID_MAX_OUT,
				M6020_PITCH_GYRO_PID_MAX_IOUT,
