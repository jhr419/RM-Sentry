...
//6020
//ecd
#define M6020_YAW_ECD_PID_KP 30.0f
#define M6020_YAW_ECD_PID_KI 0.0f
#define M6020_YAW_ECD_PID_KD 2.2f
#define M6020_YAW_ECD_PID_MAX_OUT 5000.0f
#define M6020_YAW_ECD_PID_MAX_IOUT 0.0f

#define M6020_PITCH_ECD_PID_KP 90.0f
#define M6020_PITCH_ECD_PID_KI 0.0f
#define M6020_PITCH_ECD_PID_KD 0.1f

//rpm
#define M6020_MAX_VOLTAGE 10000.0f
#define M6020_MOTOR_RPM_PID_KP 10.0f
#define M6020_MOTOR_RPM_PID_KI 0.0f
#define M6020_MOTOR_RPM_PID_KD 0.0f
#define M6020_MOTOR_RPM_PID_MAX_OUT M6020_MAX_VOLTAGE
#define M6020_MOTOR_RPM_PID_MAX_IOUT 0.0f
...
fp32 M6020_rpm_pid_k[3] = {M6020_MOTOR_RPM_PID_KP, M6020_MOTOR_RPM_PID_KI, M6020_MOTOR_RPM_PID_KD};
...
void car_init(void)//TODO:如何制定car类型及其参数
{
	...
	gimbal_init(PID_POSITION,
				M6020_yaw_ecd_pid_k,
				M6020_pitch_ecd_pid_k,
				M6020_rpm_pid_k,
				M6020_YAW_ECD_PID_MAX_OUT,M6020_YAW_ECD_PID_MAX_IOUT,
				M6020_MOTOR_RPM_PID_MAX_OUT,M6020_MOTOR_RPM_PID_MAX_IOUT);
