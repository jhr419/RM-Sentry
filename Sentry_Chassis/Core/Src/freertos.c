...
void MX_FREERTOS_Init(void) {
  ...
  /* add threads, ... */
	...
	osThreadDef(carStateTask, StartCarStateTask, osPriorityNormal, 0, 128);
	carStateTaskHandle = osThreadCreate(osThread(carStateTask), NULL);
